...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-ops@v0.2.4-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-strided-ops/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/math-strided-ops/actions/workflows/test.yml?query=branch:v0.2.4
